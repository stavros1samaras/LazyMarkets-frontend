...
export const MARKET_EVENTS = [
    {
        ...
        description: "The announcement of significant new tariffs by US President Donald Trump in early April 2025 caused intense volatility in the stock markets, with sharp drops in indices like the Dow Jones and S&P 500 as investors feared a trade war and a slowdown in economic growth.",
        code: "TrmpTrrffShck"
    },
    {
    ...
    },
    {
        ...
        description: "A surge in major tech stocks including Apple, Microsoft, and Google led to a strong market rally, driven by impressive quarterly earnings and optimistic future guidance.",
        code: "TchStckRlly"
    },
    {
        ...
        description: "Global oil prices fell sharply due to oversupply and decreased demand forecasts, impacting energy sector stocks and causing broader market concern.",
        code: "LPrcCrsh"
    },
    {
        ...
        description: "The US Federal Reserve announced a significant interest rate hike to combat inflation, causing a temporary decline in stock markets and increased bond yields.",
        code: "FdrlRsrvRtHk"
    },
    {
        ...
        description: "The declaration of a global pandemic caused massive sell-offs in stock markets worldwide, with unprecedented volatility in multiple sectors.",
        code: "GlblPndmcPnc"
    },
    {
        title: "Global Pandemic Panic",
